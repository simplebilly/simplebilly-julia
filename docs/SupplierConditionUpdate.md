...
------------ | ------------- | ------------- | -------------
**`currency`** | **`String`** | Currency for the minimum order value. | [optional] [default to nothing]
...
**`supplierContactId`** | **`String`** | The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity. | [optional] [default to nothing]
