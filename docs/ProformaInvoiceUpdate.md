...
**`currency`** | [**`*CurrencyCode`**](CurrencyCode.md) |  | [optional] [default to nothing]
...
**`issueDate`** | **`Date`** |  | [optional] [default to nothing]
...
**`status`** | [**`*ProformaInvoiceStatus`**](ProformaInvoiceStatus.md) | &#x60;draft&#x60; | &#x60;sent&#x60; | &#x60;converted&#x60;. | [optional] [default to nothing]
