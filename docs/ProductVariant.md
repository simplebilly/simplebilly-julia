...
**`productId`** | **`String`** | The parent product this variant belongs to. References the product entity. | [default to nothing]
**`sku`** | **`String`** | Variant-specific SKU (must be unique per tenant). | [default to nothing]
