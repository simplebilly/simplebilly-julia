...
------------ | ------------- | ------------- | -------------
**`activityType`** | [**`*ActivityType`**](ActivityType.md) | One of: call | email | meeting | task | note | [optional] [default to nothing]
...
**`status`** | [**`*ActivityStatus`**](ActivityStatus.md) | One of: open | done | cancelled | [optional] [default to nothing]
**`subject`** | **`String`** | Short subject line. | [optional] [default to nothing]
