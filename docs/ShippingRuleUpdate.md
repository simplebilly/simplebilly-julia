...
**`name`** | **`String`** | Delivery-method label, e.g. \&quot;Standardversand\&quot;. | [optional] [default to nothing]
**`notes`** | **`String`** |  | [optional] [default to nothing]
**`price`** | **`String`** | Shipping cost in the shop&#39;s currency. | [optional] [default to nothing]
