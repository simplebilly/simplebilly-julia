...
**`orderDate`** | **`Date`** |  | [optional] [default to nothing]
**`poNumber`** | **`String`** |  | [optional] [default to nothing]
**`status`** | [**`*PurchaseOrderStatus`**](PurchaseOrderStatus.md) | One of: draft | ordered | partially_received | received | cancelled | [optional] [default to nothing]
