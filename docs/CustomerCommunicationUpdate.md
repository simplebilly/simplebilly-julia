...
**`channel`** | [**`*CommunicationChannel`**](CommunicationChannel.md) |  | [optional] [default to nothing]
**`contactId`** | **`String`** | The contact (customer/supplier) this communication belongs to. References the contact entity. | [optional] [default to nothing]
**`counterparty`** | **`String`** | Email/phone of the counterparty, if applicable. | [optional] [default to nothing]
**`direction`** | [**`*CommunicationDirection`**](CommunicationDirection.md) |  | [optional] [default to nothing]
