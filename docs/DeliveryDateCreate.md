...
**`orderNumber`** | **`String`** | Sales order number (&#x60;order.order_number&#x60;). | [default to nothing]
...
**`promisedDate`** | **`Date`** | Date promised to the customer. | [default to nothing]
**`status`** | [**`*DeliveryDateStatus`**](DeliveryDateStatus.md) | One of: promised | confirmed | rescheduled | fulfilled | late | cancelled | [default to nothing]
