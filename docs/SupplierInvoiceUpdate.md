...
**`invoiceDate`** | **`Date`** |  | [optional] [default to nothing]
**`invoiceNumber`** | **`String`** |  | [optional] [default to nothing]
**`lineItems`** | **`Any`** | JSON array of &#x60;{product_id, name, quantity, unitPriceNet, taxRate}&#x60;. | [optional] [default to nothing]
...
**`status`** | [**`*SupplierInvoiceStatus`**](SupplierInvoiceStatus.md) | One of: draft | matched | has_variances | posted | cancelled | [optional] [default to nothing]
