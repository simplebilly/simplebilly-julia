...
Official Julia client for the [SimpleBilly API](https://simplebilly.com/api/docs).
...
> published under [Releases](https://github.com/simplebilly/simplebilly-julia/releases).

## Installation

The package is published to the Julia package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages) for public repos — free for public packages).
See the [Releases](https://github.com/simplebilly/simplebilly-julia/releases) page for the list
